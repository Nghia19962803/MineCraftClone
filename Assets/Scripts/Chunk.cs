...
public class Chunk : MonoBehaviour
{
    ...
    private float textureWidth = 0.083f;    // 0.083 = 1/12 (because Atlat this game contain 12 textures)
    ...
    private Vector2 tIceTop = new Vector2(4, 11);
    private Vector2 tIceSide = new Vector2(3, 10);
    ...
    void CubeTop(int x, int y, int z, byte block)
    {
        ...
        else if (Block(x, y, z) == textureType.ice.GetHashCode())
        {
            texturePos = tIceTop;
        }
    ...
    void Cube(Vector2 texturePos)
    {
        ...
        newUV.Add(new Vector2(textureWidth * texturePos.x + textureWidth, textureWidth * texturePos.y));    //0.083 * 7 + 0.083
